...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.blog','data' => ['title' => 'Edit Post']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit Post']); ?>
    <div class="card">
        <h1>Edit Post</h1>

        <form action="<?php echo e(route('posts.update', $post)); ?>" method="POST" style="margin-top: 24px;">
            <?php echo csrf_field(); ?>
            ...
            <div style="margin-top: 20px;">
                ...
                <textarea id="content" name="content" rows="8" required><?php echo e(old('content', $post->content)); ?></textarea>
            </div>

            <div class="actions">
                <button type="submit" class="button">Update</button>
                <a href="<?php echo e(route('posts.show', $post)); ?>">Cancel</a>
            </div>
        </form>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/legion/DEV/Prepa/2eme/projetWeb/blog/resources/views/posts/edit.blade.php ENDPATH**/ ?>